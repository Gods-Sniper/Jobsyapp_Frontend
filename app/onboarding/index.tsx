  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.title}>Explore quick service provided</Text>
        <Text style={styles.titleBold}>to you in your area</Text>
      ...
      <View style={styles.bottomContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/onboarding/onbaording2")}
        >
          <Image
