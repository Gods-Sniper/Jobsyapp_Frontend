    ...
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.title}>
          <Text style={styles.titlePurple}>Get available and qualify workers </Text>
          <Text style={styles.titleBold}>for your job services</Text>
        </Text>
        <Text style={styles.subtitle}>
          Here, you will be able of providing short or{'\n'}long-term job for those interested.
        </Text>
      </View>
      <View style={styles.bottomContainer}>
        <TouchableOpacity style={styles.circleButton} onPress={() => router.push('/onboarding')}>
          <Image
